...
configurations = {
    ...
    1: dict(
        ...
        momentum=0.99,
        weight_decay=0.0005,
        interval_validate=8000000000000000000000,
    )
}
...
def imshow_label(label_show):
    ...
    plt.savefig('productImage/label')
    #plt.show()    
...
class Trainer(object):
    ...
    def validate(self):
        ...
        plt.savefig('productImage/validate')
        #plt.show()
